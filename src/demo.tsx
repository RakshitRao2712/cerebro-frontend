...
export default function Demo(props: Partial<typeof settings> & { frontContent?: ReactNode }) {
  ...
  return (
    <div data-demo-scroll data-slipstream-demo role="region" aria-label="Cerebro"
      ...
      `}</style>
      {face ? <GlyphPortal word={s.word} fontFamily={family} fontWeight={900} style={{ fontFamily: family, color: "#ff8c00" }} scrollLength={s.scrollLength} interactive={s.interactive} annotations={s.annotations} enterLabel="" front={props.frontContent ?? <></>}>
        <></>
